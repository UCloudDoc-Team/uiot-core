...
![](https://i.loli.net/2019/07/30/5d3fef5beacee76067.png)

2.当设备发现云平台下发的期望值时会调用属性的回调函数处理。使用设备当前属性值更新云平台上的属性值<br>
![](https://i.loli.net/2019/07/30/5d3fef371bc7567077.png)
...
![](https://i.loli.net/2019/07/30/5d3fef306db9728910.png)
...
```
执行结果
![](https://i.loli.net/2019/07/30/5d4006aa2692775970.png)
...
![](https://i.loli.net/2019/07/30/5d4014a11315a74697.png)
